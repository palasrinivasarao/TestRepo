...
{
    public partial class FillFOrmDetailsWithEdit
    {
        /// <summary>
        ...
        public void Key_sequence_TxtBreedInput(RepoItemInfo inputtagInfo)
        {
        	...
        	"American Eskimo", "American Eskimo Mix", "American Pit Bull", "Alaskan Malamute", "Alaskan Huskie", "American Pit Bull Terrier", "Dachshund", "Basador", "Basenji",
        	 "Basset Hound", "Hovawart", "Papillon", "Otter Hound", "Petr Husky"};
		...
		foreach (var Breed in pickedValues)
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$BreedInput' with focus on 'inputtagInfo'.", inputtagInfo);
            inputtagInfo.FindAdapter<InputTag>().PressKeys(BreedInput);
        }
