...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The MinimizeEnlargedRecentRecords recording.
    /// </summary>
    [TestModule("47ca4b5c-fdeb-49de-8f32-06e6cf39be5b", ModuleType.Recording, 1)]
    public partial class MinimizeEnlargedRecentRecords : ITestModule
    {
        /// <summary>
        ...
        static MinimizeEnlargedRecentRecords instance = new MinimizeEnlargedRecentRecords();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public MinimizeEnlargedRecentRecords()
        {
        }
        ...
        /// </summary>
        public static MinimizeEnlargedRecentRecords Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            // Validate if the Minimize button exists
            Report.Log(ReportLevel.Info, "Validation", "Validate if the Minimize button exists\r\nValidating Exists on item 'ApplicationUnderTest.RecentRecords.RecentRecords_Minimize'.", repo.ApplicationUnderTest.RecentRecords.RecentRecords_MinimizeInfo, new RecordItemIndex(0));
            ...
            // Validate if the Table Recent record exists
            Report.Log(ReportLevel.Info, "Validation", "Validate if the Table Recent record exists\r\nValidating Exists on item 'ApplicationUnderTest.HomePage.Table_RecentRecords'.", repo.ApplicationUnderTest.HomePage.Table_RecentRecordsInfo, new RecordItemIndex(3));
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validate if the Record Content Exists in Enlarged Format\r\nValidating Exists on item 'ApplicationUnderTest.RecentRecords.Table_RecordsContent_EnlargedView'.", repo.ApplicationUnderTest.RecentRecords.Table_RecordsContent_EnlargedViewInfo, new RecordItemIndex(7));
            Validate.Exists(repo.ApplicationUnderTest.RecentRecords.Table_RecordsContent_EnlargedViewInfo);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "User", "The Value for Minimize Operation is Verified In Recent Records", new RecordItemIndex(8));
