...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The CreateViewTwo recording.
    /// </summary>
    [TestModule("02598f6c-7761-483f-a878-9a88cd8ac435", ModuleType.Recording, 1)]
    public partial class CreateViewTwo : ITestModule
    {
        /// <summary>
        ...
        static CreateViewTwo instance = new CreateViewTwo();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public CreateViewTwo()
        {
            Value = "";
            FilterValue = "New";
        }
        ...
        /// </summary>
        public static CreateViewTwo Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// </summary>
        [TestVariable("24a5f199-7184-456c-80e5-44de8215c9e1")]
        public string Value
        {
            get { return _Value; }
            set { _Value = value; }
        ...
        /// </summary>
        [TestVariable("3414d515-f062-4fb0-8454-fc24fd4149ff")]
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Wait", "Waiting 5s to exist. Associated repository item: 'ApplicationUnderTest.DogLicensePage.Btn_Drpdown_RelationalOp'", repo.ApplicationUnderTest.DogLicensePage.Btn_Drpdown_RelationalOpInfo, new ActionTimeout(5000), new RecordItemIndex(19));
            repo.ApplicationUnderTest.DogLicensePage.Btn_Drpdown_RelationalOpInfo.WaitForExists(5000);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.DogLicensePage.Btn_Drpdown_RelationalOp' at Center.", repo.ApplicationUnderTest.DogLicensePage.Btn_Drpdown_RelationalOpInfo, new RecordItemIndex(20));
            repo.ApplicationUnderTest.DogLicensePage.Btn_Drpdown_RelationalOp.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '{Down} ' with focus on 'ApplicationUnderTest.DogLicensePage.Btn_Drpdown_RelationalOp'.", repo.ApplicationUnderTest.DogLicensePage.Btn_Drpdown_RelationalOpInfo, new RecordItemIndex(21));
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '{Enter}' with focus on 'ApplicationUnderTest.DogLicensePage.Btn_Drpdown_RelationalOp'.", repo.ApplicationUnderTest.DogLicensePage.Btn_Drpdown_RelationalOpInfo, new RecordItemIndex(23));
            repo.ApplicationUnderTest.DogLicensePage.Btn_Drpdown_RelationalOp.PressKeys("{Enter}");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Delay", "Waiting for 200ms.", new RecordItemIndex(24));
            Delay.Duration(200, false);
            
            Report.Log(ReportLevel.Info, "User", "The Relational Operator that does not contain New in Status Column are added to the Filter", new RecordItemIndex(25));
            
            Report.Log(ReportLevel.Info, "Wait", "Waiting 5s to exist. Associated repository item: 'ApplicationUnderTest.DogLicensePage.TxtBox_FilterValue_Status'", repo.ApplicationUnderTest.DogLicensePage.TxtBox_FilterValue_StatusInfo, new ActionTimeout(5000), new RecordItemIndex(26));
            repo.ApplicationUnderTest.DogLicensePage.TxtBox_FilterValue_StatusInfo.WaitForExists(5000);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '$FilterValue2' with focus on 'ApplicationUnderTest.DogLicensePage.TxtBox_FilterValue_Status'.", repo.ApplicationUnderTest.DogLicensePage.TxtBox_FilterValue_StatusInfo, new RecordItemIndex(27));
            repo.ApplicationUnderTest.DogLicensePage.TxtBox_FilterValue_Status.PressKeys("$FilterValue2");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Delay", "Waiting for 200ms.", new RecordItemIndex(28));
            Delay.Duration(200, false);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '{Enter}' with focus on 'ApplicationUnderTest.DogLicensePage.TxtBox_FilterValue_Status'.", repo.ApplicationUnderTest.DogLicensePage.TxtBox_FilterValue_StatusInfo, new RecordItemIndex(29));
            ...
            Report.Log(ReportLevel.Info, "User", "The Records are filtered based on the  Status column that should not contain the value New", new RecordItemIndex(31));
            
            Report.Log(ReportLevel.Info, "Wait", "Waiting 5s to exist. Associated repository item: 'ApplicationUnderTest.HomePage.Btn_Filter'", repo.ApplicationUnderTest.HomePage.Btn_FilterInfo, new ActionTimeout(5000), new RecordItemIndex(32));
