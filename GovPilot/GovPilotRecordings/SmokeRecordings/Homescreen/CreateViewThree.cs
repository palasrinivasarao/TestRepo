...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The CreateViewThree recording.
    /// </summary>
    [TestModule("4404ef5d-94b0-4052-83d9-4ca6a98b5007", ModuleType.Recording, 1)]
    public partial class CreateViewThree : ITestModule
    {
        /// <summary>
        ...
        static CreateViewThree instance = new CreateViewThree();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public CreateViewThree()
        {
            Value = "";
            FilterValue3 = "";
        }
        ...
        /// </summary>
        public static CreateViewThree Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// </summary>
        [TestVariable("1bc5e1cd-cc1a-41b2-9210-73ebfe7996d1")]
        public string Value
        {
            get { return _Value; }
            set { _Value = value; }
        ...
        /// <summary>
        /// Gets or sets the value of variable FilterValue3.
        /// </summary>
        [TestVariable("618d626b-3ba5-4ffb-9a44-73c753666c4c")]
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Wait", "Waiting 10s for the attribute 'Enabled' to equal the specified value '(null)'. Associated repository item: 'ApplicationUnderTest.DogLicensePage.Txt_ViewName_All'", repo.ApplicationUnderTest.DogLicensePage.Txt_ViewName_AllInfo, new RecordItemIndex(1));
            repo.ApplicationUnderTest.DogLicensePage.Txt_ViewName_AllInfo.WaitForAttributeEqual(10000, "Enabled", (string)null);
            ...
            Report.Log(ReportLevel.Info, "Wait", "Waiting 10s for the attribute 'Visible' to equal the specified value '(null)'. Associated repository item: 'ApplicationUnderTest.DogLicensePage.Btn_Filter'", repo.ApplicationUnderTest.DogLicensePage.Btn_FilterInfo, new RecordItemIndex(3));
            repo.ApplicationUnderTest.DogLicensePage.Btn_FilterInfo.WaitForAttributeEqual(10000, "Visible", (string)null);
            
            Report.Log(ReportLevel.Info, "Wait", "Waiting 10s for the attribute 'Enabled' to equal the specified value '(null)'. Associated repository item: 'ApplicationUnderTest.DogLicensePage.Btn_Filter'", repo.ApplicationUnderTest.DogLicensePage.Btn_FilterInfo, new RecordItemIndex(4));
            repo.ApplicationUnderTest.DogLicensePage.Btn_FilterInfo.WaitForAttributeEqual(10000, "Enabled", (string)null);
            ...
            Report.Log(ReportLevel.Info, "Wait", "Waiting 10s for the attribute 'Visible' to equal the specified value '(null)'. Associated repository item: 'ApplicationUnderTest.DogLicensePage.BtnIcon_AddFilter'", repo.ApplicationUnderTest.DogLicensePage.BtnIcon_AddFilterInfo, new RecordItemIndex(9));
            repo.ApplicationUnderTest.DogLicensePage.BtnIcon_AddFilterInfo.WaitForAttributeEqual(10000, "Visible", (string)null);
            
            Report.Log(ReportLevel.Info, "Wait", "Waiting 5s for the attribute 'Enabled' to equal the specified value '(null)'. Associated repository item: 'ApplicationUnderTest.DogLicensePage.BtnIcon_AddFilter'", repo.ApplicationUnderTest.DogLicensePage.BtnIcon_AddFilterInfo, new RecordItemIndex(10));
            repo.ApplicationUnderTest.DogLicensePage.BtnIcon_AddFilterInfo.WaitForAttributeEqual(5000, "Enabled", (string)null);
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence from variable '$FilterValue3' with focus on 'ApplicationUnderTest.DogLicensePage.TxtBox_FilterValue'.", repo.ApplicationUnderTest.DogLicensePage.TxtBox_FilterValueInfo, new RecordItemIndex(25));
            repo.ApplicationUnderTest.DogLicensePage.TxtBox_FilterValue.PressKeys(FilterValue3);
            Delay.Milliseconds(0);
